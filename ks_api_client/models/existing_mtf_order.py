...
class ExistingMTFOrder(object):
    ...
    def __init__(self, orderId=None, quantity=None, price=None, disclosedQuantity=None, triggerPrice=None, validity=None, local_vars_configuration=None):  # noqa: E501
        """ExistingMTFOrder - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def orderId(self):
        """Gets the orderId of this ExistingMTFOrder.  # noqa: E501

        Order ID of the order to be modified  # noqa: E501

        :return: The orderId of this ExistingMTFOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def orderId(self, orderId):
        """Sets the orderId of this ExistingMTFOrder.

        Order ID of the order to be modified  # noqa: E501

        :param orderId: The orderId of this ExistingMTFOrder.  # noqa: E501
        :type orderId: str
        """
    ...
    @property
    def quantity(self):
        """Gets the quantity of this ExistingMTFOrder.  # noqa: E501

        Order quantity - specified in same unit as quoted in market depth  # noqa: E501

        :return: The quantity of this ExistingMTFOrder.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this ExistingMTFOrder.

        Order quantity - specified in same unit as quoted in market depth  # noqa: E501

        :param quantity: The quantity of this ExistingMTFOrder.  # noqa: E501
        :type quantity: int
        """
    ...
    @property
    def price(self):
        """Gets the price of this ExistingMTFOrder.  # noqa: E501

        Order Price, non zero positive for limit order and zero for market order  # noqa: E501

        :return: The price of this ExistingMTFOrder.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this ExistingMTFOrder.

        Order Price, non zero positive for limit order and zero for market order  # noqa: E501

        :param price: The price of this ExistingMTFOrder.  # noqa: E501
        :type price: float
        """
    ...
    def disclosedQuantity(self):
        """Gets the disclosedQuantity of this ExistingMTFOrder.  # noqa: E501

        Quantity to be disclosed in order  # noqa: E501

        :return: The disclosedQuantity of this ExistingMTFOrder.  # noqa: E501
        :rtype: int
        """
    ...
    def disclosedQuantity(self, disclosedQuantity):
        """Sets the disclosedQuantity of this ExistingMTFOrder.

        Quantity to be disclosed in order  # noqa: E501

        :param disclosedQuantity: The disclosedQuantity of this ExistingMTFOrder.  # noqa: E501
    ...
    def triggerPrice(self):
        """Gets the triggerPrice of this ExistingMTFOrder.  # noqa: E501

        Trigger price, required for stoploss or supermultiple order  # noqa: E501

        :return: The triggerPrice of this ExistingMTFOrder.  # noqa: E501
        :rtype: float
        """
    ...
    def triggerPrice(self, triggerPrice):
        """Sets the triggerPrice of this ExistingMTFOrder.

        Trigger price, required for stoploss or supermultiple order  # noqa: E501

        :param triggerPrice: The triggerPrice of this ExistingMTFOrder.  # noqa: E501
    ...
    @property
    def validity(self):
        """Gets the validity of this ExistingMTFOrder.  # noqa: E501

        Validity of the order - GFD, IOC etc  # noqa: E501

        :return: The validity of this ExistingMTFOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def validity(self, validity):
        """Sets the validity of this ExistingMTFOrder.

        Validity of the order - GFD, IOC etc  # noqa: E501

        :param validity: The validity of this ExistingMTFOrder.  # noqa: E501
        :type validity: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExistingMTFOrder):
            return False
