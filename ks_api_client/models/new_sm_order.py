...
class NewSMOrder(object):
    ...
    def __init__(self, instrumentToken=None, transactionType=None, quantity=None, price=None, validity=None, variety=None, disclosedQuantity=None, triggerPrice=None, tag=None, local_vars_configuration=None):  # noqa: E501
        """NewSMOrder - a model defined in OpenAPI"""  # noqa: E501
    ...
    def instrumentToken(self):
        """Gets the instrumentToken of this NewSMOrder.  # noqa: E501

        Instrument token of the scrip to be traded  # noqa: E501

        :return: The instrumentToken of this NewSMOrder.  # noqa: E501
        :rtype: int
        """
    ...
    def instrumentToken(self, instrumentToken):
        """Sets the instrumentToken of this NewSMOrder.

        Instrument token of the scrip to be traded  # noqa: E501

        :param instrumentToken: The instrumentToken of this NewSMOrder.  # noqa: E501
    ...
    def transactionType(self):
        """Gets the transactionType of this NewSMOrder.  # noqa: E501

        Transaction Type - BUY or SELL  # noqa: E501

        :return: The transactionType of this NewSMOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def transactionType(self, transactionType):
        """Sets the transactionType of this NewSMOrder.

        Transaction Type - BUY or SELL  # noqa: E501

        :param transactionType: The transactionType of this NewSMOrder.  # noqa: E501
    ...
    @property
    def quantity(self):
        """Gets the quantity of this NewSMOrder.  # noqa: E501

        Order quantity - specified in same unit as quoted in market depth  # noqa: E501

        :return: The quantity of this NewSMOrder.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this NewSMOrder.

        Order quantity - specified in same unit as quoted in market depth  # noqa: E501

        :param quantity: The quantity of this NewSMOrder.  # noqa: E501
        :type quantity: int
        """
    ...
    @property
    def price(self):
        """Gets the price of this NewSMOrder.  # noqa: E501

        Order Price, non zero positive for limit order and zero for market order  # noqa: E501

        :return: The price of this NewSMOrder.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this NewSMOrder.

        Order Price, non zero positive for limit order and zero for market order  # noqa: E501

        :param price: The price of this NewSMOrder.  # noqa: E501
        :type price: float
        """
    ...
    @property
    def validity(self):
        """Gets the validity of this NewSMOrder.  # noqa: E501

        Validity of the order - GFD, IOC etc  # noqa: E501

        :return: The validity of this NewSMOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def validity(self, validity):
        """Sets the validity of this NewSMOrder.

        Validity of the order - GFD, IOC etc  # noqa: E501

        :param validity: The validity of this NewSMOrder.  # noqa: E501
        :type validity: str
        """
    ...
    @property
    def variety(self):
        """Gets the variety of this NewSMOrder.  # noqa: E501

        Variety of the order - REGULAR, AMO, SQUAREOFF - for Super Multiple Orders etc  # noqa: E501

        :return: The variety of this NewSMOrder.  # noqa: E501
        :rtype: str
        """
    ...
    def variety(self, variety):
        """Sets the variety of this NewSMOrder.

        Variety of the order - REGULAR, AMO, SQUAREOFF - for Super Multiple Orders etc  # noqa: E501

        :param variety: The variety of this NewSMOrder.  # noqa: E501
        :type variety: str
        """
        allowed_values = ["REGULAR", "SQUAREOFF"]  # noqa: E501
    ...
    def disclosedQuantity(self):
        """Gets the disclosedQuantity of this NewSMOrder.  # noqa: E501

        Quantity to be disclosed in order  # noqa: E501

        :return: The disclosedQuantity of this NewSMOrder.  # noqa: E501
        :rtype: int
        """
    ...
    def disclosedQuantity(self, disclosedQuantity):
        """Sets the disclosedQuantity of this NewSMOrder.

        Quantity to be disclosed in order  # noqa: E501

        :param disclosedQuantity: The disclosedQuantity of this NewSMOrder.  # noqa: E501
    ...
    def triggerPrice(self):
        """Gets the triggerPrice of this NewSMOrder.  # noqa: E501

        Trigger price, required for stoploss or supermultiple order  # noqa: E501

        :return: The triggerPrice of this NewSMOrder.  # noqa: E501
        :rtype: float
        """
    ...
    def triggerPrice(self, triggerPrice):
        """Sets the triggerPrice of this NewSMOrder.

        Trigger price, required for stoploss or supermultiple order  # noqa: E501

        :param triggerPrice: The triggerPrice of this NewSMOrder.  # noqa: E501
    ...
    @property
    def tag(self):
        """Gets the tag of this NewSMOrder.  # noqa: E501

        Tag for this order  # noqa: E501

        :return: The tag of this NewSMOrder.  # noqa: E501
        :rtype: str
        """
        return self._tag
    ...
    @tag.setter
    def tag(self, tag):
        """Sets the tag of this NewSMOrder.

        Tag for this order  # noqa: E501

        :param tag: The tag of this NewSMOrder.  # noqa: E501
        :type tag: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NewSMOrder):
            return False
